...
OpenThread is released under the [BSD 3-Clause license](https://github.com/openthread/ot-nrf528xx/blob/master/LICENSE). See the [`LICENSE`](https://github.com/openthread/ot-nrf528xx/blob/master/LICENSE) file for more information.
